...
//     }
   ...
   stage('Docker build and push') {
	 ...
	 echo $secret_key
         ...
         docker login -u AWS -p $DOCKER_LOGIN_PASSWORD 579621469191.dkr.ecr.ap-south-1.amazonaws.com
	 docker build -t 579621469191.dkr.ecr.ap-south-1.amazonaws.com/sivakrishna:SAMPLE-PROJECT-${BUILD_NUMBER} .
	 docker push 579621469191.dkr.ecr.ap-south-1.amazonaws.com/sivakrishna:SAMPLE-PROJECT-${BUILD_NUMBER}
